...
exports.sendQuestionsNotification = functions.database.ref('/studentResponses/{bid}/{uid}').onWrite((event) => {
    ...
    return Promise.all([getDeviceTokensPromise, getLikedProfilePromise]).then((results) => {
        ...
        const payload = {
            notification: {
                ...
                body: 'A student has awnswered your questions, have a look.',
                badge: '1',
...
exports.sendInviteNotification = functions.database.ref('/organisedChats/{uid}/{bid}').onWrite((event) => {
    ...
    return Promise.all([getDeviceTokensPromise, getMatchedProfilePromise]).then((results) => {
        ...
        const payload = {
            notification: {
                ...
                body: 'Congratulations! You have a new interivew invite',
                badge: '1',
